...
- Command-0, the toolbar board control, or a deliberate editor pinch opens the board. Editor pinch continuously drives the mounted page with a 3% dead zone and quadratic resistance. Release at 18% outward travel settles onto the board; reversal/cancellation returns to writing. Native event capture lasts through gesture end. Physical trackpad verification remains CAN-07.
