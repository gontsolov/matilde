...
| ID | Status | Item and completion criteria |
| --- | --- | --- |
| CAN-01 | Planned | **Continuous zoom with resistance.** Track the gesture as the editor becomes its pinned sheet. Settling into a sheet locks into writing; incidental gestures must not eject the user. Preserve keyboard alternatives, position, and Reduce Motion. Current navigation uses a threshold-triggered 340 ms flight. |
