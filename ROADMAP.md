...
| CAN-11 | Done | **Clamp document zoom-out speed.** Time-based tracking caps progress at 1.8/sec and eases toward the finger target; delayed frames cannot cause catch-up jumps. Outward release uses a distance-scaled cubic settle capped at 2/sec. All 35 tests and app build/signature checks pass; toolbar round trip and restored editor focus checked live without editing writing. Physical pinch feel remains CAN-07. |
